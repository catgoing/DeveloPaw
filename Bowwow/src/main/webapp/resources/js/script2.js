...
$("body").append('<div class="fixed-button active"><a href="/store/storeMain" class="btn btn-md btn-primary" style="opacity : 0.8">스토어 메인</a> </div>');var $window=$(window),nav=$(".fixed-button");
