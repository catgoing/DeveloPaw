...
#menu_wrap {position:absolute;top:10;left:0;bottom:0;width:250px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
													...
													<div class="col-lg-12">
														...
														<br>
															<div class="map_wrap">
															    ...
															    <div id="menu_wrap" class="bg_white" style="z-index: 10000;height: 450px;">
															        <div class="option">
															            <div>
															                <form onsubmit="searchPlaces(); return false;">
															                    키워드 : <input type="text" value="강남 동물병원" id="keyword" size="15"> 
