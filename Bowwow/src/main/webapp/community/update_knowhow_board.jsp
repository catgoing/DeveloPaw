												...
												name="fr" onsubmit="return null_check()">
													...
													<c:set var="sub_class" value="${vo.sub_class }"/>
														...
														<c:if test="${sub_class eq '1' }">
													      ...
													      <div class="btn-group btn-group-toggle" data-toggle="buttons">
													        <label for="dog" class="btn active" role="button" >교육/훈련
												          		<input id="dog" type="radio" name="sub_class" value="0">
												          	</label>
													       	 <label for="cat" class="btn" role="button">급여/식이
												          <input id="cat"type="radio" name="sub_class" value="1" checked="checked">												          </label>
													        <label class="btn" role="button">건강
													          <input type="radio" name="sub_class" value="2">
													        </label>
													        <label class="btn" role="button">생활꿀팁
													          <input type="radio" name="sub_class" value="3">
													        </label>
													      </div>
													    </div>
														</c:if>
														<c:if test="${sub_class eq '2' }">
													      ...
													      <div class="btn-group btn-group-toggle" data-toggle="buttons">
													        <label for="dog" class="btn active" role="button" >교육/훈련
													       	 ...
													       	 <label for="cat" class="btn" role="button">급여/식이
												          <input id="cat"type="radio" name="sub_class" value="1">												          </label>
													        <label class="btn" role="button">건강
													          <input type="radio" name="sub_class" value="2"  checked="checked">
													        </label>
													        <label class="btn" role="button">생활꿀팁
													          <input type="radio" name="sub_class" value="3">
													        </label>
