...
<script>
	...
	function imageChangeCheck() {
		...
		$("p")
				...
				.each(
						function() {
							...
							$("#thum_select")
									.append(
											'<div class="radio-container" style="text-align:center">');
							$("#thum_select")
									.append(
											'<input type="radio" style="text-align:center" class="thum" name="img1" checked="checked" value="'
													+ $(this).attr('src')
													+ '"/>');
							$("#thum_select").append(
		...
		$(".imgs").append(
				'<input type="hidden" name="img_locas" value="' + imgar + '">');
	}
</script>
											...
											<div class="container">
												...
												<form action="insertBoard" method="post" enctype="multipart/form-data">
													<div>
														...
														고양이 <input type="radio" name="animal_class" value="3">
														자유
													</div>
													<br>
