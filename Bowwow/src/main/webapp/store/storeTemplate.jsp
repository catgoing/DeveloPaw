...
<link href="https://fonts.googleapis.com/css2?family=Do+Hyeon&display=swap" rel="stylesheet">
    ...
    <!-- waves.css -->
<<<<<<<< HEAD:Bowwow/src/main/webapp/store/storeTemplate.jsp
    <link rel="stylesheet" href="../	resources/pages/waves/css/waves.min.css" type="text/css" media="all">
========
    <link rel="stylesheet" href="/resources/pages/waves/css/waves.min.css" type="text/css" media="all">
>>>>>>>> origin/seunghyeon:Bowwow/src/main/webapp/store/productDetail.jsp
    <!-- Required Fremwork -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        <a href="storeMain.jsp"><i class="fa fa-home"></i> 스토어 메인  </a>
                        <a href="#"> 카테고리 </a>
                        <span></span>
                    </div>
                </div>
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-hash="product-1" class="product__big__img" src="../resources/images/dog.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product__details__tab">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                ...
                                quis, sem.</p>
                                <img alt="" src="../resources/images/F021L.jpg">
                            </div>
