...
<!-- waves.css -->
<link rel="stylesheet"
	href="/main/resources/pages/waves/css/waves.min.css" type="text/css"
	media="all">
<!-- Required Fremwork -->
...
<!-- Style.css -->
<link rel="stylesheet" type="text/css"
	href="/main/resources/css/style.css">
<link rel="stylesheet" type="text/css"
	href="/main/resources/css/test.css">
																	...
																	<div class="featured__item">
																		<div>
																			<a href="productDetail.html"> <img
																				src="https://projectbit.s3.us-east-2.amazonaws.com/catImg/${list.s_image }.jpg"
																				alt="">
																			</a>
																		</div>
																		...
																		<div class="featured__item__text"
																			style="width: 200px;">
																			<h6>
																				<a href="productDetail.html">${list.p_name }...</a>
																			</h6>
																			<h5>${list.price }원</h5>
																		</div>
																	</div>
